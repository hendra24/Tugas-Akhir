...
namespace org.TKinect
{
    public class TSkeleton
    {
       ...
       // public HandState HandRightState { get; set; }
        ...
        //public JointTrackingState LeanTrackingState { get; set; }
        //
        // Summary:
        ...
        public TSkeleton Clone()
        {
            ...
            ts.Position = new SkeletonPoint[this.Position.Length];
            for (int a = 0; a < ts.Orientation.Length; a++)
            {
            ...
            ts.TrackingState = new JointTrackingState[this.TrackingState.Length];
            for (int a = 0; a < ts.Orientation.Length; a++)
            {
